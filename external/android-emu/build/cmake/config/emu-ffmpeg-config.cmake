...
set(FFMPEG_LIBAVCODEC
    "${PREBUILT_ROOT}/lib/libavcodec${CMAKE_SHARED_LIBRARY_SUFFIX}")
set(FFMPEG_LIBAVFORMAT
    "${PREBUILT_ROOT}/lib/libavformat${CMAKE_SHARED_LIBRARY_SUFFIX}")
set(FFMPEG_LIBAVUTIL
    "${PREBUILT_ROOT}/lib/libavutil${CMAKE_SHARED_LIBRARY_SUFFIX}")
set(FFMPEG_LIBRARIES
    "${PREBUILT_ROOT}/lib/libavformat${CMAKE_SHARED_LIBRARY_SUFFIX};${PREBUILT_ROOT}/lib/libavfilter${CMAKE_SHARED_LIBRARY_SUFFIX};${PREBUILT_ROOT}/lib/libavcodec${CMAKE_SHARED_LIBRARY_SUFFIX};${PREBUILT_ROOT}/lib/libswresample${CMAKE_SHARED_LIBRARY_SUFFIX};${PREBUILT_ROOT}/lib/libswscale${CMAKE_SHARED_LIBRARY_SUFFIX};${PREBUILT_ROOT}/lib/libavutil${CMAKE_SHARED_LIBRARY_SUFFIX};${X264_LIBRARIES};${VPX_LIBRARIES}"
)
if(WINDOWS)
